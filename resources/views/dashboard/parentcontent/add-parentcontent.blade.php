...
<div>
         <div class="grid-form1">
          <h3 id="forms-horizontal">Parent Content Page</h3>
            ...
            <form class="form-horizontal" action="{{ route('parentcontent.store') }}" method="POST"  enctype="multipart/form-data" >
                @csrf
                    <div class="form-group"  Style=" display:inline-flex; margin-left:35px;" >
                        ...
                        <select name="parentpage_id"  id="parentpage_id" class="form-select form-select-sm" Style="margin-left:85px "> 
                    ...
                    <div class="form-group" Style=" display:inline-flex; margin-left:35px;">
                        ...
                        <input type="file"  Style="margin-left:40px " name="thumbnailimg" placeholder="image" onchange="previewFile(this)">
